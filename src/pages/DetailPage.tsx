    ...
    return (<div className="DetailPage">
            ...
            >
                <div className="popup-content">
                    <h1> 지금이 기회예요!</h1>
                    <h2> 평균보다 <span style={{backgroundColor: '#ebff00', padding: '0 5px'}}>무려 50% 저렴</span>한
                        가격으로 <br/> 강의를 수강하실 수 있습니다!</h2>
                    <p>사람이 더 모이면 리워드가 추가될 수도 있어요 <br/> 공유하고 친구와 함께 더 많은 혜택을 누려보세요</p>
                </div>
            </Modal>
            <div className="form">
                <div className="left">
